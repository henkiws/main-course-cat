          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="{{ route('cert.create') }}" class="btn btn-sm btn-primary">Add New Certificate</a>
              </div>
              @endrole
            </div>
            <!-- /.card-header -->
                    ...
                    @foreach($list as $key => $val)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('cert.destroy',[$val->id]) }}" class="btn btn-danger btn-sm btn-equal" onclick="event.preventDefault();document.getElementById('form{{ $val->id }}').submit()">
                                    <i class="fas fa-trash"></i> 
                                </a>
                                <form id="form{{ $val->id }}" action="{{ route('cert.destroy',[$val->id]) }}" method="POST" class="d-none">
                                  @csrf
                                  @method('delete')
                                </form>
                                @endrole
